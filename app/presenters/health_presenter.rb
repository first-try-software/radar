...
class HealthPresenter
  def initialize(health:, raw_score: nil, off_track_count: 0, at_risk_count: 0, total_count: 0, entity_label: "projects", methodology: nil)
  ...
  # Counts
  attr_reader :off_track_count, :at_risk_count, :total_count, :entity_label
  ...
  def off_track_detail
    "#{off_track_count} of #{total_count} #{entity_label} off-track"
  end
  ...
  def at_risk_detail
    "#{at_risk_count} of #{total_count} #{entity_label} at-risk"
  end
